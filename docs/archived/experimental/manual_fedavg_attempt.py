...
# %%
# really this calculate threshold should be the federated computation
#
...
def train_fn(top_n_features=10):
    ...
    return tff.federated_value(tff.federated_map(over_tr, [top_n_features, tff.federated_broadcast(tr)]))


# %%
@tff.tf_computation(tf.float64, )
